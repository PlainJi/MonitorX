...
int config_init(void) {
    ...
    do {
        ...
        printf("[CONFIG] git_username: %s\n", conf.git_username);
        printf("[CONFIG] git_update_cont_itv_h: %d\n", conf.git_update_cont_itv_h);
        printf("[CONFIG] bili userid: %s\n", conf.bili_userid);
        printf("[CONFIG] bili_update_folw_itv_m: %d\n", conf.bili_update_folw_itv_m);
        printf("[CONFIG] bili_update_stat_itv_h: %d\n", conf.bili_update_stat_itv_h);
