...
void ui_Monitor_screen_init(void)
{
    ...
    // lv_img_set_src(ui_Disconnect, IMG(disconnect_48));
    ...
    lv_obj_set_style_bg_img_src(ui_PanelMonitor, IMG(bg), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_img_set_src(ui_CpuUsagePointer, IMG(big_pointer));
    ...
    lv_obj_set_style_arc_img_src(ui_MemUsageArc, IMG(mem_usage1), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_arc_img_src(ui_MemUsageArc, IMG(mem_usage2), LV_PART_INDICATOR | LV_STATE_DEFAULT);
    ...
    lv_img_set_src(ui_CpuTemp, IMG(small_pointer));
    ...
    lv_img_set_src(ui_GpuUsagePointer, IMG(big_pointer));
    ...
    lv_obj_set_style_arc_img_src(ui_GMemUsageArc, IMG(mem_usage1), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_arc_img_src(ui_GMemUsageArc, IMG(mem_usage2), LV_PART_INDICATOR | LV_STATE_DEFAULT);
    ...
    lv_img_set_src(ui_GpuTemp, IMG(small_pointer));
...
void ui_Git_screen_init(void)
{
    ...
    lv_imgbtn_set_src(ui_Git_ImgButtonLogo, LV_IMGBTN_STATE_RELEASED, NULL, IMG(git_released), NULL);
    lv_imgbtn_set_src(ui_Git_ImgButtonLogo, LV_IMGBTN_STATE_PRESSED, NULL, IMG(git_pressed), NULL);
    ...
    lv_obj_set_style_bg_img_src(ui_Git_Slider_Loading, IMG(git_released_loading), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_img_src(ui_Git_Slider_Loading, IMG(git_released), LV_PART_INDICATOR | LV_STATE_DEFAULT);
